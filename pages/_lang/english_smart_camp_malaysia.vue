...
<section class="b02">
  <div class="container">
    <!--<div class="owl-carousel b02_sb1">-->
      ...
      <div class="col6 b03_col6">
        <div class="b03_in1">
          <div class="flex flex-justify">
            <div class="col0">
              <p class="b03_in1_tx1 js-tmr_days">
                {{cd.days}}
              </p>
              <p class="b03_in1_tx2 js-tmr_days_txt">
                {{$t('days')}}
              </p>
            </div>
            <div class="col0 b03_fix_with">
              <div class="flex1">
                <div>
                  <p class="b03_in1_tx1 js-tmr_hour">
                    {{cd.hours}}
                  </p>
                ...
                <div>
                  <p class="b03_in1_tx1 js-tmr_min">
                    {{cd.minutes}}
                  </p>
                  <p class="b03_in1_tx2 js-tmr_min_txt">
                    {{$t('minutes')}}
                  </p>
                </div>
                <div class="b03_in3">
                ...
                <div>
                  <p class="b03_in1_tx1 js-tmr_sec">
                    {{cd.seconds}}
                  </p>
                  <p class="b03_in1_tx2 js-tmr_sec_txt">
                    {{$t('seconds')}}
                  </p>
                </div>
              </div>
...
<section class="b08">
  <div class="container">
    <div class="b08_row">
      <div class="flex flex-justify flex-v-center">
        <div class="col6 no-pad-rt" id="carousellSchool">
          <client-only>
  ...
  <div class="container">
    ...
    <div class="b10_02_flex">
      <div v-for="(reason,index) in $t('landing.reasons_to_join')" :key="index">
        <header><span class="num">{{index+1}}</span> <span>{{reason.head}}</span></header>
...
export default {
    ...
    data() {
      return {
            ...
            reviews:{
              ...
              images:[
                {
                  src:'/img/rev_sc_3.jpg',
                },
                {
                  src:'/img/rev_sc_4.jpg',
                },
                {
                  src:'/img/rev_sc_5.jpg',
                },
                {
                  src:'/img/rev_sc_6.jpg',
                },
                {
                  src:'/img/rev_sc_7.jpg',
                },
                {
                  src:'/img/rev_sc_8.jpg',
                },
                {
                  src:'/img/rev_sc_1.jpg',
                },
                {
                  src:'/img/rev_sc_2.jpg',
                },
                {
                  src:'/img/rev_sc_10.jpg',
                },
                {
                  src:'/img/rev_sc_11.jpg',
                },
                {
                  src:'/img/rev_sc_12.jpg',
                },
                {
                  src:'/img/rev_sc_13.jpg',
                },
                {
                  src:'/img/rev_sc_14.jpg',
                },
                {
                  src:'/img/rev_sc_15.jpg',
                },
                {
                  src:'/img/rev_sc_16.jpg',
                },
                {
                  src:'/img/rev_sc_17.jpg',
                },
                {
                  src:'/img/rev_sc_18.jpg',
                },
                {
                  src:'/img/rev_sc_19.jpg',
                },
                {
                  src:'/img/rev_sc_20.jpg',
                },
                {
                  src:'/img/rev_sc_21.jpg',
                },
              ],
              index: null
            },
            ...
            countries: [
                //{ id: '', name: this.$t('form.please_select'), dial_code: '+...'}
            ],
            addons: [],
            order:{
                productID: '',
    ...
    computed: {
      showBottomButtons(){
        if(this.$store.state.deviceWidth <= 600){
...
&:before,&:after{
      content: "";
      border-bottom: 4px #ff5722 solid;
      flex: 1;
      margin: 0 20px;
      @media(max-width: 600px){
